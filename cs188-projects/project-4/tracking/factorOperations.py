...
def joinFactorsByVariableWithCallTracking(callTrackingList=None):
    ...
    def joinFactorsByVariable(factors: List[Factor], joinVariable: str):
        ...
        if numVariableOnLeft > 1:
            print("Factor failed joinFactorsByVariable typecheck: ", currentFactorsToJoin)
    ...
    def eliminate(factor: Factor, eliminationVariable: str):
        ...
        for newAssignmentDict in newFactor.getAllPossibleAssignmentDicts():
            ...
            for elimValue in factor.variableDomainsDict()[eliminationVariable]:
                assignmentDict = newAssignmentDict.copy()
                assignmentDict[eliminationVariable] = elimValue
                summedProb += factor.getProbability(assignmentDict)
            newFactor.setProbability(newAssignmentDict, summedProb)
